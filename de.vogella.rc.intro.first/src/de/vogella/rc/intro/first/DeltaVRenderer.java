...
public class DeltaVRenderer extends AbstractTimeBarRenderer {
     ...
     */
    public DeltaVRenderer(Printer printer) {
        super(printer);
    }
    ...
    private void defaultDraw(GC gc, Rectangle drawingArea, TimeBarViewerDelegate delegate, Interval interval,
        ...
        long numOfSeconds = interval.getSeconds();
        ...
        SwtGraphicsHelper.drawStringLeftAlignedVCenter(gc, interval.toString(), drawingArea.x + 5, drawingArea.y + 15);
        
        SwtGraphicsHelper.drawStringCentered(gc, Long.toString(numOfSeconds), iRect);
