 ...
 */
public class EclipseInterval extends PropertyObservableBase implements Interval, PropertyChangeListener {
    /** begin date. */
     ...
     */
    public EclipseInterval(JaretDate from, JaretDate to) {
        _begin = from.copy();
