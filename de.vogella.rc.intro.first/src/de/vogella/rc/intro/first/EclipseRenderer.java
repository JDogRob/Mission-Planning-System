...
public class EclipseRenderer extends AbstractTimeBarRenderer {
     ...
     */
    public EclipseRenderer(Printer printer) {
        super(printer);
    }
    ...
    private void defaultDraw(GC gc, Rectangle drawingArea, TimeBarViewerDelegate delegate, Interval interval,
        ...
        SwtGraphicsHelper.drawStringCentered(gc, "Eclipse", iRect);
