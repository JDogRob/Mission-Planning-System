 ...
 */
public class TDRSSInterval extends PropertyObservableBase implements Interval, PropertyChangeListener {
    /** begin date. */
     ...
     */
    public TDRSSInterval(JaretDate from, JaretDate to) {
        _begin = from.copy();
